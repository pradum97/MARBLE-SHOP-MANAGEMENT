...
public class ProductConfig implements Initializable {
    ...
    public TableColumn<Discount , String> colDiscountType;
    ...
    ObservableList<TAX> taxList ;
    ObservableList<Discount> discountList ;
    ...
    private void setDiscountData() {
        ...
        tableViewDiscount.setItems(discountList);

        colDiscount.setCellValueFactory(new PropertyValueFactory<>("discount"));
        colDiscountType.setCellValueFactory(new PropertyValueFactory<>("discountType"));
